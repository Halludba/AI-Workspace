...
audit_pages.append([Block('2.7.11 Apply Reusable PDF Styler',3,[
 ('body','For a PDF creation or restyling task under an enabled profile, resolve the active PDF style before presentation work.'),
